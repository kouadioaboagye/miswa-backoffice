...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
    (
        ...
        return (
            <div
                className={cn(
                    'flex h-[48px] w-full items-center rounded-xl bg-background text-[1.4rem] ring-offset-background gap-3 px-3 py-6 [&_svg]:size-5 [&_svg]:cursor-pointer focus-within:ring-2 focus-within:ring-[#0E4D79] focus-within:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 border border-[#CBD5E0]',
                    className
                )}
            >
                {leftIcon}
