...
const DetailsPropertiesSection = () => {
    const properties = [
        {
            id: 1,
    ...
    return (
        <section className="bg-white py-16 sm:py-20 md:py-24">
            <div className="mx-auto flex max-w-[88%] flex-col gap-12">
                {/* Titre et sous-titre */}
            ...
            <div className="relative">
                ...
                <div className="relative z-0 mx-auto flex flex-col items-center justify-center gap-6 bg-[#14385C] p-8 pt-20 text-white md:px-12 md:py-20">
                    ...
                    <div className="flex max-w-[75%] flex-col items-center py-40 justify-between gap-8 lg:flex-row lg:items-center">
                        {/* Colonne gauche - Texte */}
                        <div className="flex max-w-[50%] flex-col gap-5 text-center lg:text-left">
                            <h3 className="mb-2 text-lg font-bold opacity-60 md:text-2xl">
                                Rejoignez-notre newsletter
                            </h3>
                            <h4 className="mb-4 text-2xl font-bold md:text-6xl">
                                Abonnez-vous à notre <br /> newsletter
                            </h4>
...
export default DetailsPropertiesSection;
