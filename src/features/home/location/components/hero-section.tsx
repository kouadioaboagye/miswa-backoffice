            ...
            <div className='w-full flex justify-center mt-28'>
                ...
                <div className="flex flex-col justify-between gap-24 h-[110%] w-[92%] px-0">
                    ...
                    <div className="relative z-10 bg-white pr-12 rounded-[25px] pt-12 w-fullmx-auto  w-[62%]">
                        ...
                        {/* Champs de recherche */}
                        <div className="flex flex-col items-center mt-2 h-full p-6 md:flex-row gap-4 items-end rounded-[12px] border border-[#1EA64A]">
                            {/* Champ Ville */}
                            <div className="flex-1">
                                <label className="block text-xl font-medium text-gray-700 mb-2">Ville</label>
                            ...
                            {/* Champ Budget */}
                            <div className="flex-1">
                                <label className="block text-xl font-medium text-gray-700 mb-2">Budget</label>
                                <div className="relative">
                                    <div className="flex items-center gap-2">
                                        <span className="text-xl text-gray-500">100k</span>
                                        ...
                                        <span className="text-xl text-gray-500">400k</span>
                                    </div>
                                </div>
                            </div>

                            {/* Bouton Rechercher */}
                            <Button variant="secondary" size="default" className="transition-colors shadow-md shadow-[#1ea64a]">
                                Rechercher
                            </Button>
                        </div>
                    </div>
