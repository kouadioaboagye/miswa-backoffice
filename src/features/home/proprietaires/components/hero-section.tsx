...
const HeroSection = () => {
    ...
    return (
        <div className="flex h-[540px] w-full flex-col items-center justify-between bg-white pt-10 sm:px-4 md:px-8">
            ...
            <div
                className="flex text-center text-6xl font-bold text-[#161C2D] sm:max-w-[90%]  md:max-w-[55%] lg:text-7xl"
                style={{ lineHeight: '5.5rem' }}
            >
                Gérez tous vos biens immobiliers depuis une seule plateforme !
            </div>
            <p className="text-4xl font-normal text-center tracking-[-0.02em] text-[#757575] leading-[1.7] font-['Open_Sans'] max-w-[45%]">
                Miswa vous offre une solution complète pour optimiser vos
                revenus locatifs, suivre vos propriétés et maintenir de bonnes
                relations avec vos locataires.
            </p>
