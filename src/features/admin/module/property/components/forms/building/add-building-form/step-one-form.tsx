...
function StepOneForm({ form }: Readonly<StepOneFormProps>) {
    ...
    const { data: businessesResponse, isLoading: isBusinessesLoading } =
        useListOwnersQuery();
    const { data: businesses = [], total: businessesTotal = 0 } =
        businessesResponse || {};
    ...
    return (
        <div className="space-y-20">
            <section className="space-y-6">
                ...
                <div>
                    <Label htmlFor="business" isRequired>
                        Propriétaire
                    </Label>
                    <Controller
                        name="business"
                ...
                <div className="grid grid-cols-2 gap-10 mb-4">
                    <div>
                        <Label htmlFor="nomBatiment" isRequired>
                            Nom du bâtiment
                        </Label>
                        <Input
                            id="nomBatiment"
                            placeholder="Batiment a"
                            {...form.register('nomBatiment')}
                        />
                        <InputErrorMessage
                            message={errors.nomBatiment?.message}
                        />
                    </div>
                    <div>
            ...
            <section>
                ...
                <div className="grid grid-cols-2 gap-10">
                    ...
                    <div className="grid grid-cols-2 gap-10">
                        <div>
                            <Label htmlFor="municipality" isRequired>
                                Ville/Commune
                            </Label>
                            <Controller
                                name="municipality"
                        ...
                        <div>
                            ...
                            />
                            <InputErrorMessage
                                message={errors.quartier?.message}
                            />
                        </div>
                    </div>
                    <div>
                        <Label htmlFor="geoolocation" isRequired>
                            Géolocalisation
                        </Label>
