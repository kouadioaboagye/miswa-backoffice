...
} from '@/lib/data-service/general/general.hooks';
        ...
        <div>
            <section>
                ...
                <div className="grid grid-cols-3 gap-4 mb-4">
                    <div>
                        <Label htmlFor="telephonePrincipal" isRequired>
                        ...
                        />
                        <InputErrorMessage
                            message={errors.telephonePrincipal?.message}
                        />
                    </div>
                ...
                <div className="grid grid-cols-3 gap-4 mb-4">
                    <div>
                        <Label htmlFor="paysResidence" isRequired>
                            Pays de résidence
                        </Label>
                        <Controller
                            name="paysResidence"
                    ...
                    <div>
                        <Label htmlFor="commune" isRequired>
                            Commune
                        </Label>
                        <Controller
                            name="commune"
                                        ...
                                        <SelectContent>
                                            {municipalities.length > 0 &&
                                                municipalities
                                                    .filter(
                                                        (municipality) =>
                                                            municipality.id_country?.toString() ===
                                                            selectedCountryId
                                                    )
                                                    .map(
                                                        (
            ...
            <section>
                ...
                <div className="grid grid-cols-3 gap-4 mb-4">
                    <div>
                        <Label htmlFor="profession" isRequired>
                            Profession
                        </Label>
                        <Controller
                            name="profession"
                    ...
                    <div>
                        <Label htmlFor="employeur" isRequired>
                            Employeur
                        </Label>
                        <Input
                            id="employeur"
                        ...
                        />
                        <InputErrorMessage
                            message={errors.employeur?.message}
                        />
                    </div>

                    <div>
                        <Label htmlFor="revenuMensuel" isRequired>
                        ...
                        <Input
                            ...
                            type="number"
                            placeholder="500000"
                            {...form.register('revenuMensuel', {
                                valueAsNumber: true
                            })}
                        />
                        <InputErrorMessage
                            message={errors.revenuMensuel?.message}
                        />
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div className="grid grid-cols-3 gap-4">
                    <div>
                        <Label htmlFor="modeReception" isRequired>
                            Mode de réception
                        </Label>
                        <Controller
                            name="modeReception"
                    ...
                    <div>
                        ...
                        />
                        <InputErrorMessage
                            message={errors.titulaireCompte?.message}
                        />
                    </div>
                </div>
            </section>
...
>>>>>>> cf6ca9142c15a2150ca80ac9fb3da830bdc7a3b8
}
